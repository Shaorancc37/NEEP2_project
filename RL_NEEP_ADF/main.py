...
if __name__ == '__main__':
    ...
    for problem in problemSet:
        ...
        do = partial(train, name, Epoch, learning_rate,batch_size, layer_num,ADF_NUM , main_HLength , adf_HLength)
    ...
    #train(name="Sphere5",Epoch=50,learning_rate = 1e-4,batch_size = 100, layer_num = 1, ADF_NUM=1, main_HLength = 10 , adf_HLength = 3 ,cou=0)